...
import { ArrowDown, Flame, Clock, MapPin, Sparkles, Award } from 'lucide-react';
  ...
  return (
    <section className="relative pt-32 sm:pt-40 pb-20 md:pb-28 bg-[#f5f5f2] overflow-hidden">
      <div className="container max-w-7xl">
        {/* Giant Impact Headline (Image 2 Built Flavor style) */}
        <div className="text-center max-w-5xl mx-auto mb-10">
          ...
          <h1 className="font-display text-[clamp(2.8rem,9vw,7.5rem)] font-extrabold text-zinc-900 leading-[0.92] tracking-tight mb-6">
            CHARCOAL & <span className="text-red-600">FIRE.</span>
          </h1>

          <p className="text-zinc-600 text-base sm:text-xl font-medium max-w-2xl mx-auto leading-relaxed mb-8">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            <button
              ...
              className="bg-red-600 hover:bg-red-700 text-white text-xs sm:text-sm font-bold uppercase tracking-widest px-8 py-3.5 rounded-full transition-all duration-300 shadow-lg shadow-red-600/25 hover:shadow-xl hover:shadow-red-600/35"
            >
              Book a Table
            </button>
            <a
        ...
        {/* Hero Showcase Bento & Widgets Layout (Image 1 + Image 2 hybrid) */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch mt-12">
          {/* Main Hero Image Bento with Floating Chips */}
          <div className="lg:col-span-8 bento-card relative overflow-hidden min-h-[380px] sm:min-h-[460px] group">
            <img
            ...
            {/* Floating Tags (Image 1 & 2 inspired) */}
            ...
            <div className="absolute bottom-6 left-6 right-6 flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4 text-white">
              ...
              <div className="flex items-center gap-2 bg-white/20 backdrop-blur-md px-4 py-2 rounded-full border border-white/20 text-xs font-semibold">
          ...
          {/* Right Sidebar Bento Widgets (Image 1 FoodKea style) */}
          <div className="lg:col-span-4 flex flex-col gap-6">
            {/* Hours & Live Status Bento Widget */}
            <div className="bento-card p-6 flex flex-col justify-between flex-1">
              ...
              <div>
                <span className="text-xs uppercase font-bold text-zinc-400 tracking-wider block mb-1">Operating Hours</span>
                <h4 className="font-serif text-2xl font-bold text-zinc-900">Everyday 7am – 12am</h4>
                <p className="text-xs text-zinc-500 mt-1">Breakfast, Lunch, Dinner & Late-night Suya</p>
              </div>

              <div className="mt-6 pt-4 border-t border-zinc-100 flex items-center justify-between text-xs font-semibold text-zinc-700">
                <span>Call Line:</span>
            ...
            <div className="bento-card-dark p-6 flex flex-col justify-between flex-1 relative overflow-hidden">
              ...
              <button
                onClick={onOpenReservation}
                className="mt-6 w-full bg-white text-zinc-900 text-xs font-bold uppercase tracking-wider py-3 rounded-full hover:bg-zinc-100 transition-colors relative z-10"
              >
                Order / Reserve Table
              </button>
            </div>
